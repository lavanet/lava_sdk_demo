...
if (!REACT_APP_ETHER_ENDPOINT) {
  throw Error("REACT_APP_ETHER_ENDPOINT property not found in .env");
}
...
export default {
  ...
  ETHER_ENDPOINT: REACT_APP_ETHER_ENDPOINT,
};
